			...
			<div class="loginer">
				...
				<form role="form" action="" method="post">
					...
					<div class="input-group">
						<input type="password" class="form-pass" id="pwd" name="password" placeholder="Kata Sandi" equired autofocus><span title="Show Password" class="input-group-btn"><button class="buttn" type="button" id="show"><i class="glyphicon glyphicon-eye-open"></i></button>
         				</span>
					</div>
					</div>
					<div class="form-group">
						<input type="submit" name="login" class="butn" value="Log Masuk" />
					</div>
				</form>
				<button class="chgt" id="thm" title="Change Background" onclick="chgbg()"><span class="glyphicon glyphicon-refresh"></span></button>
			</div>
    		<?php echo $appnam; ?> &#169; <?php echo $begin . (($begin != $now) ? '-' . $now : ''); ?> PDAM dan POLINDRA
		</div>
	</div>
